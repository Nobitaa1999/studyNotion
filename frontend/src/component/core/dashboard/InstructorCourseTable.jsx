        ...
        <Tbody>
          {courses?.length === 0 ? (
            ...
            courses?.map((course) => (
              ...
              >
                <Td className="flex flex-1 gap-x-4 items-start min-h-[148px]">
                  <img
                    src={course?.thumbnail}
                    alt={course?.courseName}
                    className="h-[148px] w-[220px] rounded-lg object-fill"
                  />
                  <div className="flex flex-col justify-between flex-1 self-start min-h-[148px]">
                    <p className="text-lg font-semibold text-richblack-5">
                      {course.courseName}
                    </p>
                   
                    <p className="text-xs text-richblack-5 line-clamp-2 h-[40px]  text-ellipsis">
